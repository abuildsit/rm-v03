...
async def main():
    ...
    try:
        ...
        invoices = [
            ...
            # Test invoices that match the AI-extracted data from example-remittance.pdf
            {
                "id": "50b6bb09-612c-4b18-96fc-3cd9e058024e",
                "organizationId": "42f929b1-8fdb-45b1-a7cf-34fae2314561",
                "invoiceId": "50b6bb09-612c-4b18-96fc-3cd9e058024e",
                "invoiceNumber": "INV397945",
                "contactName": "Test Client A",
                "contactId": "a74e319d-db70-4874-8fda-411771f82df0",
                "invoiceDate": datetime(2025, 7, 11),
                "dueDate": datetime(2025, 7, 25),
                "status": InvoiceStatus.AUTHORISED,
                "amountDue": Decimal("351.15"),
                "amountPaid": Decimal("0.00"),
                "total": Decimal("351.15"),
                "currencyCode": "AUD",
                "reference": "Test Invoice A",
                "isDiscounted": False,
                "hasErrors": False,
            },
            {
                "id": "169beba2-fc84-465f-9f44-2b0705f7b105",
                "organizationId": "42f929b1-8fdb-45b1-a7cf-34fae2314561",
                "invoiceId": "169beba2-fc84-465f-9f44-2b0705f7b105",
                "invoiceNumber": "INV398405",
                "contactName": "Test Client B",
                "contactId": "a74e319d-db70-4874-8fda-411771f82df0",
                "invoiceDate": datetime(2025, 7, 11),
                "dueDate": datetime(2025, 7, 25),
                "status": InvoiceStatus.AUTHORISED,
                "amountDue": Decimal("801.12"),
                "amountPaid": Decimal("0.00"),
                "total": Decimal("801.12"),
                "currencyCode": "AUD",
                "reference": "Test Invoice B",
                "isDiscounted": False,
                "hasErrors": False,
            },
            {
                "id": "89e441bb-5301-4c15-9269-a79806db2ff6",
                "organizationId": "42f929b1-8fdb-45b1-a7cf-34fae2314561",
                "invoiceId": "89e441bb-5301-4c15-9269-a79806db2ff6",
                "invoiceNumber": "INV398325",
                "contactName": "Test Client C",
                "contactId": "a74e319d-db70-4874-8fda-411771f82df0",
                "invoiceDate": datetime(2025, 7, 11),
                "dueDate": datetime(2025, 7, 25),
                "status": InvoiceStatus.AUTHORISED,
                "amountDue": Decimal("58.03"),
                "amountPaid": Decimal("0.00"),
                "total": Decimal("58.03"),
                "currencyCode": "AUD",
                "reference": "Test Invoice C",
                "isDiscounted": False,
                "hasErrors": False,
            },
            {
                "id": "736f54d6-fa3e-4c65-b863-fa7b8844d8ed",
                "organizationId": "42f929b1-8fdb-45b1-a7cf-34fae2314561",
                "invoiceId": "736f54d6-fa3e-4c65-b863-fa7b8844d8ed",
                "invoiceNumber": "INV397915",
                "contactName": "Test Client D",
                "contactId": "a74e319d-db70-4874-8fda-411771f82df0",
                "invoiceDate": datetime(2025, 7, 11),
                "dueDate": datetime(2025, 7, 25),
                "status": InvoiceStatus.AUTHORISED,
                "amountDue": Decimal("387.15"),
                "amountPaid": Decimal("0.00"),
                "total": Decimal("387.15"),
                "currencyCode": "AUD",
                "reference": "Test Invoice D",
                "isDiscounted": False,
                "hasErrors": False,
            },
            {
                "id": "ba962263-5995-4236-a8a8-e70239b5bb57",
                "organizationId": "42f929b1-8fdb-45b1-a7cf-34fae2314561",
                "invoiceId": "ba962263-5995-4236-a8a8-e70239b5bb57",
                "invoiceNumber": "INV398595",
                "contactName": "Test Client E",
                "contactId": "a74e319d-db70-4874-8fda-411771f82df0",
                "invoiceDate": datetime(2025, 7, 11),
                "dueDate": datetime(2025, 7, 25),
                "status": InvoiceStatus.AUTHORISED,
                "amountDue": Decimal("697.10"),
                "amountPaid": Decimal("0.00"),
                "total": Decimal("697.10"),
                "currencyCode": "AUD",
                "reference": "Test Invoice E",
                "isDiscounted": False,
                "hasErrors": False,
            },
        ]
