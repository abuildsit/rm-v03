    ...
    try:
        ...
        invoices = [
            ...
            # matching algorithms
            {
                ...
                "subTotal": Decimal("318.32"),
                "totalTax": Decimal("32.83"),
                "total": Decimal("351.15"),
                "amountDue": Decimal("351.15"),
                "amountPaid": Decimal("0.00"),
                "currencyCode": "AUD",
                "reference": "Test remittance matching - exact",
                "isDiscounted": False,
                "hasErrors": False,
            },
            {
                ...
                "status": InvoiceStatus.AUTHORISED,
                "subTotal": Decimal("728.29"),
                "totalTax": Decimal("72.83"),
                "total": Decimal("801.12"),
                "amountDue": Decimal("801.12"),
                "amountPaid": Decimal("0.00"),
                "currencyCode": "AUD",
                "reference": "Test remittance matching - case insensitive",
                "isDiscounted": False,
                "hasErrors": False,
            },
            {
                ...
                "contactId": str(uuid.uuid4()),
                "invoiceDate": datetime(2025, 6, 10),
                "dueDate": datetime(2025, 7, 10),
                "status": InvoiceStatus.AUTHORISED,
                "subTotal": Decimal("52.75"),
                "totalTax": Decimal("5.28"),
                "total": Decimal("58.03"),
                "amountDue": Decimal("58.03"),
                "amountPaid": Decimal("0.00"),
                "currencyCode": "AUD",
                "reference": "Test remittance matching - space normalization",
                "isDiscounted": False,
                "hasErrors": False,
            },
            {
                ...
                "status": InvoiceStatus.AUTHORISED,
                "subTotal": Decimal("351.95"),
                "totalTax": Decimal("35.20"),
                "total": Decimal("387.15"),
                "amountDue": Decimal("387.15"),
                "amountPaid": Decimal("0.00"),
                "currencyCode": "AUD",
                "reference": "Test remittance matching - special chars",
                "isDiscounted": False,
                "hasErrors": False,
            },
            {
                ...
                "status": InvoiceStatus.AUTHORISED,
                "subTotal": Decimal("633.73"),
                "totalTax": Decimal("63.37"),
                "total": Decimal("697.10"),
                "amountDue": Decimal("697.10"),
                "amountPaid": Decimal("0.00"),
                "currencyCode": "AUD",
                "reference": "Test remittance matching - complex pattern",
                "isDiscounted": False,
                "hasErrors": False,
            },
        ]
