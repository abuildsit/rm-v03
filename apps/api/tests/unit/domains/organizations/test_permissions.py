...
from src.domains.organizations.permissions import (
    ROLE_PERMISSIONS,
    Permission,
    has_permission,
)
...
class TestPermissionEnum:
    ...
    def test_permission_string_values(self):
        ...
        assert Permission.INVITE_MEMBERS.value == "invite_members"
        assert Permission.REMOVE_MEMBERS.value == "remove_members"
...
class TestRolePermissions:
    ...
    def test_auditor_has_limited_permissions(self):
        ...
        assert len(auditor_permissions) == 1

    def test_user_has_no_special_permissions(self):
        """Test that user role has no special permissions."""
...
class TestHasPermissionFunction:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (OrganizationRole.owner, Permission.INVITE_MEMBERS, True),
            (OrganizationRole.owner, Permission.REMOVE_MEMBERS, True),
            ...
            (OrganizationRole.admin, Permission.INVITE_MEMBERS, True),
            (OrganizationRole.admin, Permission.REMOVE_MEMBERS, True),
            ...
            (OrganizationRole.auditor, Permission.INVITE_MEMBERS, False),
            (OrganizationRole.auditor, Permission.REMOVE_MEMBERS, False),
            ...
            (OrganizationRole.user, Permission.INVITE_MEMBERS, False),
            (OrganizationRole.user, Permission.REMOVE_MEMBERS, False),
